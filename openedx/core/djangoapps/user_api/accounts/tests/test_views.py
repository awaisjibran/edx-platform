...
TEST_PROFILE_IMAGE_BACKEND_CONFIG = deepcopy(settings.PROFILE_IMAGE_BACKEND_CONFIG)
TEST_PROFILE_IMAGE_BACKEND_CONFIG['storage_kwargs']['base_url'] = '/profile_images/'
...
class TestAccountAPI(UserAPITestCase):
    ...
    @override_settings(PROFILE_IMAGE_BACKEND_CONFIG=TEST_PROFILE_IMAGE_BACKEND_CONFIG)
    def test_convert_relative_profile_url(self):
        """
        Test that when TEST_PROFILE_IMAGE_BACKEND_CONFIG['base_url'] begins
